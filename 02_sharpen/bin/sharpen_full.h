#ifndef HALIDE__bin___sharpen_full_h
#define HALIDE__bin___sharpen_full_h
#include <stdint.h>
...
int sharpen_full(struct halide_buffer_t *_img_input_buffer, struct halide_buffer_t *_img_output_buffer);

HALIDE_FUNCTION_ATTRS
int sharpen_full_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *sharpen_full_metadata();
