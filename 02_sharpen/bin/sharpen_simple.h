#ifndef HALIDE__bin___sharpen_simple_h
#define HALIDE__bin___sharpen_simple_h
#include <stdint.h>
...
int sharpen_simple(struct halide_buffer_t *_img_input_buffer, struct halide_buffer_t *_img_output_buffer);

HALIDE_FUNCTION_ATTRS
int sharpen_simple_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *sharpen_simple_metadata();
